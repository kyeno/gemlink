...
# This script tests that the package mirror at https://gemlink.org/depends-sources/
# contains all of the packages required to build this version of Gemlink.
#
# This script assumes you've just built Gemlink, and that as a result of that
...
MIRROR_URL_DIR="https://gemlink.org/depends-sources/"

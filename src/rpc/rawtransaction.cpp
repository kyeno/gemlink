    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            CURRENCY_UNIT + "\n"
                            ...
                            "           \"gemlinkaddress\"          (string) Gemlink address\n"
                            "           ,...\n"
                            "         ]\n"
                            "       }\n"
                            "     }\n"
...
UniValue createrawtransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\": x.xxx   (numeric, required) The key is the gemlink address, the value is the " +
            CURRENCY_UNIT + " amount\n"
                            "      ,...\n"
                            "    }\n"
                            "3. locktime              (numeric, optional, default=0) Raw locktime. Non-0 value also locktime-activates inputs\n"
                            "4. expiryheight          (numeric, optional, default=nextblockheight+" +
            strprintf("%d", DEFAULT_TX_EXPIRY_DELTA) + ") Expiry height of transaction (if Overwinter is active)\n"
                                                       "\nResult:\n"
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            CURRENCY_UNIT + "\n"
                            ...
                            "         \"type\" : \"pubkeyhash\",  (string) The type, eg 'pubkeyhash'\n"
                            "         \"addresses\" : [           (json array of string)\n"
                            "           \"t12tvKAXCxZjSmdNbao16dKXC8tRWfcF5oc\"   (string) gemlink address\n"
                            "           ,...\n"
                            "         ]\n"
                            "       }\n"
                            "     }\n"

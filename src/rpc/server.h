...
extern UniValue getblockchainsyncstatus(const UniValue& params, bool fHelp);
...
extern UniValue sendtoaddressnochange(const UniValue& params, bool fHelp);
...
extern UniValue getfreyjainfo(const UniValue& params, bool fHelp);
